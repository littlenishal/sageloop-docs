...
description: "Learn how to create effective test scenarios that lead to better insights"
---
...
<Warning>
**Note**: If you delete a scenario, its outputs and ratings are also deleted.
</Warning>
...
❌ **Don't** add 100+ scenarios upfront
...
- **[Generating Outputs](/guide/generating-outputs)** - Turn scenarios into AI responses
